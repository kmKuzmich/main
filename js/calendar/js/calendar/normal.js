...
// ---- Common Options ----
var gMonths=["Січ","Лют","Бер","Кві","Тра","Чер","Лип","Сер","Вер","Жов","Лис","Гру"];
var gWeekDay=["Нд","Пн","Вт","Ср","Чт","Пт","Сб"];	// weekday caption from Sunday to Saturday
...
var gsOutOfRange="Вибачте вказана некоректна дата";	// out-of-date-range error message. If set to "", no alerts will popup on such error.
...
var gsBottom="<A href='javascript:void(0)' class='Today' onclick='if(this.blur)this.blur();if(!fSetDate(gToday[0],gToday[1],gToday[2]))alert(\"Today is not a selectable date!\");return false;' onmouseover='return true;' title='Today'>Сьогодні : "+gToday[2]+" "+gMonths[gToday[1]-1]+" "+gToday[0]+"</A>";	// the content of the bottom section.
