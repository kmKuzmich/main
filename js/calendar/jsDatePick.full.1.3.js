...
/*
	...
	useMode (Integer) Ц Possible values are 1 and 2 as follows:
		1 Ц The calendar's HTML will be directly appended to the field supplied by target
		2 Ц The calendar will appear as a popup when the field with the id supplied in target is clicked.
	
	target (String) Ц The id of the field to attach the calendar to , usually a text input field when using useMode 2.
	
	isStripped (Boolean) Ц When set to true the calendar appears without the visual design - usually used with useMode 1
	
	selectedDate (Object) Ц When supplied , this object tells the calendar to open up with this date selected already.
	
	yearsRange (Array) Ц When supplied , this array sets the limits for the years enabled in the calendar.
	
	limitToToday (Boolean) Ц Enables you to limit the possible picking days to today's date.
	
	cellColorScheme (String) Ц Enables you to swap the colors of the date's cells from a wide range of colors.
...
g_l = [];
g_l["MONTHS"] = ["январь","‘евраль","ћарт","јпрель","ћай","»юнь","»юль","јвгуст","—ент€брь","ќкт€брь","Ќо€брь","ƒекабрь"];
g_l["DAYS_3"] = ["¬с","ѕн","¬т","—р","„т","ѕт","—б"];
g_l["MONTH_FWD"] = "";
g_l["MONTH_BCK"] = "";
g_l["YEAR_FWD"] = "";
g_l["YEAR_BCK"] = "";
