<?php
/**
 * File for class TecDocPackageStructArticleIds3Record
 * @package TecDocPackage
 * @subpackage Structs
 * @date 2013-02-10
 */
/**
 * This class stands for TecDocPackageStructArticleIds3Record originally named ArticleIds3Record
 * @package TecDocPackage
 * @subpackage Structs
 * @date 2013-02-10
 */
class TecDocPackageStructArticleIds3Record extends TecDocPackageWsdlClass
{
	/**
	 * The articleId
	...
	public $sortNo;
	/**
	 * Constructor method for ArticleIds3Record
	 ...
	 * @param int $_sortNo
	 * @return TecDocPackageStructArticleIds3Record
	 */
