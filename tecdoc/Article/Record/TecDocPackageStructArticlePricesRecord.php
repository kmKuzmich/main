<?php
/**
 * File for class TecDocPackageStructArticlePricesRecord
 * @package TecDocPackage
 * @subpackage Structs
 * @date 2013-02-10
 */
/**
 * This class stands for TecDocPackageStructArticlePricesRecord originally named ArticlePricesRecord
 * @package TecDocPackage
 * @subpackage Structs
 * @date 2013-02-10
 */
class TecDocPackageStructArticlePricesRecord extends TecDocPackageWsdlClass
{
	/**
	 * The currency
	...
	public $validDateTo;
	/**
	 * Constructor method for ArticlePricesRecord
	 * @see parent::__construct()
	 * @param string $_currency
	 * @param string $_discount
	 ...
	 * @return TecDocPackageStructArticlePricesRecord
	 */
	public function __construct($_currency = NULL,$_discount = NULL,$_hasLessDiscount = NULL,$_price = NULL,$_priceTypeId = NULL,$_priceTypeName = NULL,$_priceUnitId = NULL,$_priceUnitName = NULL,$_quantityUnitId = NULL,$_quantityUnitName = NULL,$_validDateFrom = NULL,$_validDateTo = NULL)
	{
		parent::__construct(array('currency'=>$_currency,'discount'=>$_discount,'hasLessDiscount'=>$_hasLessDiscount,'price'=>$_price,'priceTypeId'=>$_priceTypeId,'priceTypeName'=>$_priceTypeName,'priceUnitId'=>$_priceUnitId,'priceUnitName'=>$_priceUnitName,'quantityUnitId'=>$_quantityUnitId,'quantityUnitName'=>$_quantityUnitName,'validDateFrom'=>$_validDateFrom,'validDateTo'=>$_validDateTo));
	}
	/**
	 * Get currency value
	 * @return string
