<?php
/**
 * File for class TecDocPackageStructArticlePartList2RecordSeq
 * @package TecDocPackage
 * @subpackage Structs
 * @date 2013-02-10
 */
/**
 * This class stands for TecDocPackageStructArticlePartList2RecordSeq originally named ArticlePartList2RecordSeq
 * @package TecDocPackage
 * @subpackage Structs
 * @date 2013-02-10
 */
class TecDocPackageStructArticlePartList2RecordSeq extends TecDocPackageWsdlClass
{
	/**
	 * The array
	...
	public $empty;
	/**
	 * Constructor method for ArticlePartList2RecordSeq
