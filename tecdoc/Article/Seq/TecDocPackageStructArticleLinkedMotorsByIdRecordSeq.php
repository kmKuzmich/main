<?php
/**
 * File for class TecDocPackageStructArticleLinkedMotorsByIdRecordSeq
 * @package TecDocPackage
 * @subpackage Structs
 * @date 2013-02-10
 */
/**
 * This class stands for TecDocPackageStructArticleLinkedMotorsByIdRecordSeq originally named ArticleLinkedMotorsByIdRecordSeq
 * @package TecDocPackage
 * @subpackage Structs
 * @date 2013-02-10
 */
class TecDocPackageStructArticleLinkedMotorsByIdRecordSeq extends TecDocPackageWsdlClass
{
	/**
	 * The array
	...
	public $empty;
	/**
	 * Constructor method for ArticleLinkedMotorsByIdRecordSeq
