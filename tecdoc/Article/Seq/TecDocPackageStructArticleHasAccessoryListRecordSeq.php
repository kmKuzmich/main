<?php
/**
 * File for class TecDocPackageStructArticleHasAccessoryListRecordSeq
 * @package TecDocPackage
 * @subpackage Structs
 * @date 2013-02-10
 */
/**
 * This class stands for TecDocPackageStructArticleHasAccessoryListRecordSeq originally named ArticleHasAccessoryListRecordSeq
 * @package TecDocPackage
 * @subpackage Structs
 * @date 2013-02-10
 */
class TecDocPackageStructArticleHasAccessoryListRecordSeq extends TecDocPackageWsdlClass
{
	/**
	 * The array
	...
	public $empty;
	/**
	 * Constructor method for ArticleHasAccessoryListRecordSeq
