<?php
/**
 * File for class TecDocPackageStructArticleDocumentsByDocIdRecordSeq
 * @package TecDocPackage
 * @subpackage Structs
 * @date 2013-02-10
 */
/**
 * This class stands for TecDocPackageStructArticleDocumentsByDocIdRecordSeq originally named ArticleDocumentsByDocIdRecordSeq
 * @package TecDocPackage
 * @subpackage Structs
 * @date 2013-02-10
 */
class TecDocPackageStructArticleDocumentsByDocIdRecordSeq extends TecDocPackageWsdlClass
{
	/**
	 * The array
	...
	public $empty;
	/**
	 * Constructor method for ArticleDocumentsByDocIdRecordSeq
