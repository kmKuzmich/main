<?php
/**
 * File for class TecDocPackageStructArticleIds3Request
 * @package TecDocPackage
 * @subpackage Structs
 * @date 2013-02-10
 */
/**
 * This class stands for TecDocPackageStructArticleIds3Request originally named ArticleIds3Request
 * @package TecDocPackage
 * @subpackage Structs
 * @date 2013-02-10
 */
class TecDocPackageStructArticleIds3Request extends TecDocPackageWsdlClass
{
	/**
	...
	public $sort;
	/**
	 * Constructor method for ArticleIds3Request
	 ...
	 * @param int $_provider
	 * @param int $_sort
	 * @return TecDocPackageStructArticleIds3Request
	 */
