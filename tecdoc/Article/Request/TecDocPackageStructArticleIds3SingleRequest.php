<?php
/**
 * File for class TecDocPackageStructArticleIds3SingleRequest
 * @package TecDocPackage
 * @subpackage Structs
 * @date 2013-02-10
 */
/**
 * This class stands for TecDocPackageStructArticleIds3SingleRequest originally named ArticleIds3SingleRequest
 * @package TecDocPackage
 * @subpackage Structs
 * @date 2013-02-10
 */
class TecDocPackageStructArticleIds3SingleRequest extends TecDocPackageWsdlClass
{
	/**
	...
	public $sort;
	/**
	 * Constructor method for ArticleIds3SingleRequest
	 ...
	 * @param int $_provider
	 * @param int $_sort
	 * @return TecDocPackageStructArticleIds3SingleRequest
	 */
