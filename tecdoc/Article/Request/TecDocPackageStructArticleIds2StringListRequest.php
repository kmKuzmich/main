<?php
/**
 * File for class TecDocPackageStructArticleIds2StringListRequest
 * @package TecDocPackage
 * @subpackage Structs
 * @date 2013-02-10
 */
/**
 * This class stands for TecDocPackageStructArticleIds2StringListRequest originally named ArticleIds2StringListRequest
 * @package TecDocPackage
 * @subpackage Structs
 * @date 2013-02-10
 */
class TecDocPackageStructArticleIds2StringListRequest extends TecDocPackageWsdlClass
{
	/**
	...
	public $sort;
	/**
	 * Constructor method for ArticleIds2StringListRequest
	 ...
	 * @param int $_provider
	 * @param int $_sort
	 * @return TecDocPackageStructArticleIds2StringListRequest
	 */
