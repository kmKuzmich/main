<?php
/**
 * File for class TecDocPackageStructReplacedNumbersRecord
 * @package TecDocPackage
 * @subpackage Structs
 * @date 2013-02-10
 */
/**
 * This class stands for TecDocPackageStructReplacedNumbersRecord originally named ReplacedNumbersRecord
 * @package TecDocPackage
 * @subpackage Structs
 * @date 2013-02-10
 */
class TecDocPackageStructReplacedNumbersRecord extends TecDocPackageWsdlClass
{
	/**
	...
	/**
	 * Constructor method for ReplacedNumbersRecord
	 * @see parent::__construct()
	 * @param long $_replaceArticleId
	 * @param string $_replaceNumber
	 * @return TecDocPackageStructReplacedNumbersRecord
	 */
