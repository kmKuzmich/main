<?php
/**
 * File for class TecDocPackageStructChildNodesAllLinkingTargetShortCut2Record
 * @package TecDocPackage
 * @subpackage Structs
 * @date 2013-02-10
 */
/**
 * This class stands for TecDocPackageStructChildNodesAllLinkingTargetShortCut2Record originally named ChildNodesAllLinkingTargetShortCut2Record
 * @package TecDocPackage
 * @subpackage Structs
 * @date 2013-02-10
 */
class TecDocPackageStructChildNodesAllLinkingTargetShortCut2Record extends TecDocPackageWsdlClass
{
	/**
	...
	public $parentNodeId;
	/**
	 * Constructor method for ChildNodesAllLinkingTargetShortCut2Record
	 * @see parent::__construct()
	 * @param string $_assemblyGroupName
	 * @param long $_assemblyGroupNodeId
	 * @param boolean $_hasChilds
	 * @param long $_parentNodeId
	 * @return TecDocPackageStructChildNodesAllLinkingTargetShortCut2Record
	 */
