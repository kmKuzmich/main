<?php
/**
 * File for class TecDocPackageStructChildNodesPatternRecordSeq
 * @package TecDocPackage
 * @subpackage Structs
 * @date 2013-02-10
 */
/**
 * This class stands for TecDocPackageStructChildNodesPatternRecordSeq originally named ChildNodesPatternRecordSeq
 * @package TecDocPackage
 * @subpackage Structs
 * @date 2013-02-10
 */
class TecDocPackageStructChildNodesPatternRecordSeq extends TecDocPackageWsdlClass
{
	/**
	 * The array
	...
	public $empty;
	/**
	 * Constructor method for ChildNodesPatternRecordSeq
