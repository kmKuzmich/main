<?php
/**
 * File for TecDocPackageWsdlClass to communicate with SOAP service
 ...
 * @date 10/02/2013
 */
class TecDocPackageWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses TecDocPackageWsdlClass::setLastError()
	 * @uses TecDocPackageWsdlClass::initSoapClient()
	 * @uses TecDocPackageWsdlClass::initInternArrayToIterate()
	 * @uses TecDocPackageWsdlClass::_set()
	 * @param array $_arrayOfValues values
	 * @return TecDocPackageWsdlClass
	 */
	 ...
	 * @uses TecDocPackageWsdlClass::classMap()
	 * @uses TecDocPackageWsdlClass::getDefaultWsdlOptions()
	 * @uses TecDocPackageWsdlClass::setSoapClient()
	 * @param array $_wsdlOptions WSDL options
	 * @return void
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('TecDocPackageClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = TecDocPackageClassMap::classMap();
	 ...
	 * @uses TecDocPackageWsdlClass::WSDL_CACHE_WSDL
	 * @uses TecDocPackageWsdlClass::WSDL_COMPRESSION
	 * @uses TecDocPackageWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses TecDocPackageWsdlClass::WSDL_ENCODING
	 * @uses TecDocPackageWsdlClass::WSDL_EXCPTS
	 * @uses TecDocPackageWsdlClass::WSDL_FEATURES
	 * @uses TecDocPackageWsdlClass::WSDL_LOGIN
	 * @uses TecDocPackageWsdlClass::WSDL_PASSWD
	 * @uses TecDocPackageWsdlClass::WSDL_SOAP_VERSION
	 * @uses TecDocPackageWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses TecDocPackageWsdlClass::WSDL_TRACE
	 * @uses TecDocPackageWsdlClass::WSDL_TYPEMAP
	 * @uses TecDocPackageWsdlClass::WSDL_URL
	 * @uses TecDocPackageWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	 ...
	 * @uses TecDocPackageWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses TecDocPackageWsdlClass::internArrayToIterateIsArray()
	 * @uses TecDocPackageWsdlClass::getInternArrayToIterate()
	 * @return int
	 */
	 ...
	 * @uses TecDocPackageWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses TecDocPackageWsdlClass::getInternArrayToIterateOffset()
	 * @uses TecDocPackageWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses TecDocPackageWsdlClass::getInternArrayToIterateOffset()
	 * @uses TecDocPackageWsdlClass::offsetExists()
	 ...
	 * @see TecDocPackageWsdlClass::offsetGet()
	 * @uses TecDocPackageWsdlClass::offsetGet()
	 * @param int $_index
	 * @return mixed
	 */
	 ...
	 * @uses TecDocPackageWsdlClass::getAttributeName()
	 * @uses TecDocPackageWsdlClass::__toString()
	 * @uses TecDocPackageWsdlClass::_set()
	 * @uses TecDocPackageWsdlClass::_get()
	 * @uses TecDocPackageWsdlClass::setInternArrayToIterate()
	 * @uses TecDocPackageWsdlClass::setInternArrayToIterateIsArray()
	 * @uses TecDocPackageWsdlClass::setInternArrayToIterateOffset()
	 ...
	 * @uses TecDocPackageWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses TecDocPackageWsdlClass::item()
	 * @uses TecDocPackageWsdlClass::length()
	 * @return mixed
	 */
	 ...
	 * @uses TecDocPackageWsdlClass::getInternArrayToIterateIsArray()
	 * @uses TecDocPackageWsdlClass::getInternArrayToIterate()
	 * @param int $_offset
	 * @return bool true|false
	 */
