...
class banner {
	...
	function show_big_banners(){$db=new db; $slave=new slave; $cur_data=date("Y-m-d");
		$r=$db->query_lider("select * from actions where visible='1' order by lenta asc;");$n=$db->num_rows($r);$list="";
		for ($i=1;$i<=$n;$i++){
