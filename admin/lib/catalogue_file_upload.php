...
class file_upload{
	...
	function show_form(){include_once '../../lib/mysql_class.php';session_start();$db=new db;$ses_id=session_id();$model=$this->get_model();
		...
		<table width='100%' border=0 bgcolor='#ccCCCC' style='font:14px normal Tahoma;'><tr><td width='200' align='right'>Основная фотография</td><td width='50'><input type='checkbox' name='main' value='1'></td><td width='200' align='right'>Позиция</td><td width='200'><input type='text' name='lenta' value='9999' style='width:60px;'></td><td width='200' align='right'>Подпись фотографии</td><td width='200'><input type='text' name='caption' value='' style='width:180px;'></td><td align='right' width='100'>Имя файла</td><td width='250'><input type='file' style='width: 250px;' name='file'></td><td><input type='submit' value='Добавить'></td><td>&nbsp;</td></tr></table>
		</form><br />
